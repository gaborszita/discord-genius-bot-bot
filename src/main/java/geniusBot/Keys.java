...
public class Keys
{
   public static final String DISCORD_TOKEN = Config.getConfig("DISCORD_TOKEN");
   public static final String YOUTUBE_API_KEY = Config.getConfig("YOUTUBE_API_KEY");
   public static final String AUDD_API_KEY = "YOUR_AUDD_API_KEY"; // key not in use
}
